// AuthContext.js
// এই পুরো ফাইলটা src/context/AuthContext.js হিসেবে আপলোড করো (আগের ফাইল রিপ্লেস করবে)
...
export function AuthProvider({ children }) {
  ...
  const loginWithGoogle = async (role, referralCode) => {
    ...
    if (referralCode) {
      await applyReferralCode(cred.user.uid, referralCode);
    }
  };
  ...
  const signup = async (name, email, pass, role, referralCode) => {
    ...
    // ⚠️ আগে প্রোফাইল সেভ করতে হবে (coins:3 রুলের জন্য), তারপর রেফারেল প্রসেস
